...
AGraphicsGameEngineProjectile::AGraphicsGameEngineProjectile() 
{
	...
	CollisionComp->OnComponentHit.AddDynamic(this, &AGraphicsGameEngineProjectile::OnHit);		// set up a notification for when this component hits something blocking
